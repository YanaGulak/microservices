...
VALUES ((SELECT id FROM users WHERE username = 'admin'), (SELECT id FROM roles WHERE role = 'ROLE_ADMIN')),
       ((SELECT id FROM users WHERE username = 'admin'), (SELECT id FROM roles WHERE role = 'ROLE_USER')),
       ((SELECT id FROM users WHERE username = 'user'), (SELECT id FROM roles WHERE role = 'ROLE_USER'));
